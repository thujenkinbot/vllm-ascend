...
MiniMaxM2Model.forward_edge_cloud_segment = _forward_edge_cloud_segment_minimax_m2
MiniMaxM2ForCausalLM.forward_edge_cloud_segment = (
    _minimax_m2_lm_forward_edge_cloud_segment
)
